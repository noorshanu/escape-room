    ...
    <>
      ...
      <div className='bg-[url("/public/images/road-bg.png")] bg-cover relative pb-8'>
        ...
        <div className='flex justify-center gap-8 pt-4'>
          <a href="/" className='ml-2 bg-white border hover:bg-black hover:text-white border-[#433838] text-[#433838]   border-b-4  rounded-full  px-5  flex justify-center py-2.5 text-xl font-modak'> Read More</a>
